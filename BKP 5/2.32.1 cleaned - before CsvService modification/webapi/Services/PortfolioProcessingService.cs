...
// return the  error report* for the companies assosiated with the selected portfolio
    ...
    public class PortfolioProcessingService : IPortfolioProcessingService
    {
        ...
        public List<Dictionary<string, object>> SendPortfolio(PortfolioModel input)
        {
            ...
            try
            {
                ...
                //read the portfolio in order to extract the names of the companies associated  (companiesInsidePortfolioStr)
                ...
                //find the error report for each company inside the portfolio and create dictionary --> each row = company
