...
namespace webapi.Controllers
{
    ...
    public class PortfoliosController : ControllerBase
    {
        ...
        {
            // Example usage
            List<string> listData = new List<string> { "Header1,Header2,Header3", "Value1,Value2,Value3", "Value4,Value5,Value6" };
        //H:\_BKP
            string filePath = "H:/_BKP/listData.csv"; // Adjust the path as needed

            // Use the service to create a CSV file
            CsvService.CreateCsvFromList(listData, filePath);
