...
export default function ExportAssignSchedulers() {
    ...
    //TEST sendData to https://localhost:7260/portfolios'
    const handleSendData4 = () => {
        console.log(selectedRows)
        sendData4('portfolios/TestCSV', { portfoliosNumbersArray: selectedRows });
        sendData4('portfolios/PostPortfolio', { PortfolioTable: ["FIIX  TH IS  HISS","koooooooooooooooool"] });
    };
