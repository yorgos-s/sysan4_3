...
// data's LAST COLUMN 
// --> provide info about which rows are selected-- > we set these values here internally!
...
// (1) onRowSelect={handlePortfoliosRowSelect} -->  const handlePortfolioRowsSelect = ( --> selectedRows, idx <-- ) => {
//     when you want to update the data of the SAME component
// (2) state's last column  (===1 or 2)  (you can use useEffect or inside a handler from another row)
//      when you want something more complex --> assign scheduler etc



//-------------------------------------
// tableData (2d array) the data you see on the table  --> day (0), week (0), month (0)
// setTableData  to update the data you see on the table  -->  day (0),week (2), month (0)
// selectionType   0 = you can't select rows   1 = select only one row   2 = select multiple rows
// onRowSelect   to trigger an action (it returns row's data + idx)
// splitRows   (array --> eg  [3,8] )  returns a spesific part of the table
