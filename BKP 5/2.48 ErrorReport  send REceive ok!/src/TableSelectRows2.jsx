...
// data last column  provides which rows are selected --> we set these values here internally!
...
// * also we return the index of the last column as well in case you need it

export default function TableSelectRows2({ data, columnHeaders, setDataTable, selectionType, onRowSelect }) {
