...
export default function ErrorReport2(
    ...
    const submitTest5 = () => {
        console.log("test5 ERROR REPORT---->", extra, extras)
    }
    ...
    const [allPortfolios, setAllPortfolios] = useState([["portfolio4.csv", 0], ["portfolio5.csv", 0], ["portfolio6.csv", 0]]);
    console.log("ALL NAMES", allPortfolios)
    ...
    return (
        <div>
            ...
            <button onClick={submitTest5}>SUBMIT TEST 5</button>
